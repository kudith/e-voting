...
export default function ElectionsPage() {
  ...
  const [startDateFilter, setStartDateFilter] = useState("");
   ⨯ ReferenceError: deletingElectionId is not defined
    at ElectionsPage (file://C%3A/Users/faridfred/Development/e%20vote%202/e-voting/app/admin/dashboard/elections/page.js:208:36)
  206 |                 error={error}
  207 |                 isDeleting={isDeleting}
> 208 |                 deletingElectionId={deletingElectionId}
      |                                    ^
  209 |               />
  210 |             </CardContent>
  211 |           </Card> {
 ...
 GET /admin/dashboard/elections 500 in 319ms
