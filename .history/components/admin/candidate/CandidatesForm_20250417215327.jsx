...
<div className="grid gap-2">
  ...
  <Input
    ...
    className={cn(
      "transition-colors",
      errors.photo && "border-destructive focus-visible:ring-destructive"
    )}
  />
  {errors.photo && (
    <p className="text-destructive text-xs flex items-center gap-1">
...
<div className="grid gap-2">
  ...
  <Input
    ...
    className={cn(
      "transition-colors",
      errors.vision && "border-destructive focus-visible:ring-destructive"
    )}
  />
  {errors.vision && (
    <p className="text-destructive text-xs flex items-center gap-1">
...
<div className="grid gap-2">
  ...
  <Input
    ...
    className={cn(
      "transition-colors",
      errors.mission && "border-destructive focus-visible:ring-destructive"
    )}
  />
  {errors.mission && (
    <p className="text-destructive text-xs flex items-center gap-1">
...
<div className="grid gap-2">
  ...
  <Input
    ...
    className={cn(
      "transition-colors",
      errors.shortBio && "border-destructive focus-visible:ring-destructive"
    )}
  />
  {errors.shortBio && (
    <p className="text-destructive text-xs flex items-center gap-1">
...
<div className="grid gap-2">
  ...
  <Select
    ...
    onValueChange={(value) => setValue("electionId", value, { shouldValidate: true })}
  >
    <SelectTrigger
      id="electionId"
      className={cn(
