...
import DeleteConfirmation from "@/components/admin/elections/DeleteConfirmation"; // Import the DeleteConfirmation component
...
export default function ElectionTable({
  ...
  const handleConfirmDelete = async () => {
    if (electionToDelete) {
      await onDelete(electionToDelete);
    ...
    <>
      ...
      {electionToDelete && (
        <DeleteConfirmation
          ...
          count={1}
          candidateName={electionToDelete.title}
        />
      )}
    </>
  );
